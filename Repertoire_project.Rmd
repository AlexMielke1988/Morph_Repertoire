...
```{r sim_morphs, fig.align='center', fig.width=12, fig.height=12, message=F, echo = TRUE, cache = FALSE, fig.cap = "Network plot of connection between morphs based on their similarity."}
